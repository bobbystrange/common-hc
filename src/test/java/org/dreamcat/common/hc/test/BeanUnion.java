...
public class BeanUnion {
    ...
    public static BeanUnion newInstance() {
        ...
        obj.setSub1(new Sub1(date1, partnerIds[0], RandomUtil.uuid(), RANDOM.nextLong()));
        obj.setSub2(new Sub2(date2, partnerIds[1], RandomUtil.uuid(), RANDOM.nextLong()));
        obj.setSub3(new Sub3(date3, partnerIds[2], RandomUtil.uuid(), RANDOM.nextLong()));
        return obj;
    }
    ...
    public static List<Sub1> ofSub1() {
        ...
        for (long partnerId : partnerIds) {
            list.add(new Sub1(date1, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub1(date2, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub1(date3, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub1(date4, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
        }
        return list;
    }
    ...
    public static List<Sub2> ofSub2() {
        ...
        for (long partnerId : partnerIds) {
            list.add(new Sub2(date1, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub2(date2, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub2(date3, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub2(date4, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
        }
        return list;
    }
    ...
    public static List<Sub3> ofSub3() {
        ...
        for (long partnerId : partnerIds) {
            list.add(new Sub3(date1, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub3(date2, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub3(date3, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
            list.add(new Sub3(date4, partnerId, RandomUtil.uuid(), RANDOM.nextLong()));
        }
        return list;
    }
